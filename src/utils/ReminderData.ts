...
export const committeeMembers: Member[] = [
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "11/11/1982",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "02/02/1984",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "03/11/1989",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "04/04/1999",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Anoop Gupta",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "05/05/2000",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Ashwin Sahai",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "06/06/1999",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "GAURAV RANA",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "07/07/1993",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "08/08/1995",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "09/09/1998",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Shirshak Sah",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "10/11/1991",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "11/11/1997",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Devesh Nagpal",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "12/12/1994",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Ishan Agrawal",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "01/01/1996",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "02/02/1992",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Sandeep Naik",
      ...
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "03/03/1990",  // Dob from the first array
      annidate: "11/01/2022",
    },
    {
      name: "Dr. Vaibhav S",
    ...
    },
    {
      name: "Amit Kalra",
      imageUrl:
        "https://vaave.s3.amazonaws.com/album_photos/851f5ac9941d720844d143ed9cfcf60a_91c51005f6ed774ae23e91f38d26815e_thumb.jpg",
      batch: "1982 Batch",
      role: "CHAIRMAN",
      dob: "12/12/1986",  // Dob from the first array
      annidate: "11/01/2022",
    },
  ];
